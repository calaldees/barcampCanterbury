...
https://github.com/calaldees/barcampCanterbury/blob/master/events/2025/email-days-before.md
...
* On the day a timetable will be setup on a blank space of wall
    * People will 'reserve a room/table slot' with a post-it note containing a title and the name of the presenter
* Talk/focus slots are up to 30 mins.
* A 'Focused Table' is much like a normal BarCamp talk room, but will have 6-ish seats.
...
After the event ends at 16:00, we will be moving to a nearby location to continue the conversations and networking.

## See you on Sunday!

We look forward to seeing you all at BarCamp Canterbury on Sunday 23rd November.
